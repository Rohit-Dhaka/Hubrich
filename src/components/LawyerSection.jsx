                ...
                <div className="flex flex-wrap flex-row mx-[-12px] lg:pt-[239px] sm:pt-[80px] pt-[60px] ">
                    ...
                    <div className="lg:w-[50%] w-full px-[12px] z-[1] lg:pt-0 pt-4" data-aos="fade-up">
                        <div className="lg:pl-[37px]">
                            ...
                            <h3 className=' uppercase font-helvetica font-normal text-[36px] leading-[47px]  '><span className="text-Orange">M</span>arc <span className="text-Orange">J</span>oachim <span className="text-Orange">H</span>ubrich</h3>
