                ...
                <div className="flex flex-wrap flex-row mx-[-12px] lg:pt-[239px] sm:pt-[80px] pt-[60px] ">
                    ...
                    <div className="lg:w-[50%] w-full px-[12px] z-[1] lg:pt-0 pt-4" data-aos="fade-up">
                        <div className="lg:pl-[37px]">
                            <h2 className='font-helvetica font-normal text-[52px] leading-[66px] '>LAWYER <span className="text-Orange">&</span> DIVORCE COACH</h2>
                            ...
                            <button class="h-[59px]  rounded-[60px] bg-gradient-to-r from-[#0C5FD1]  to-[#8703C5] p-[1.7px] group max-w-[350px] hover:shadow-buttonshadow duration-300">
