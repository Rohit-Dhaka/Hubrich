...
const HeroSection = () => {
    ...
    return (
        <section className='relative  bg-hero  bg-cover bg-no-repeat bg-center '>
            ...
            <div className="navbar pt-[24px] z-[1] relative " data-aos="fade-down">
                <div className='max-w-[1140px] mx-auto px-[12px]'>
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className={`${show ? "navshow   " : ""}   menu flex gap-[40px] lg:items-center  max-lg:absolute max-lg:w-full max-lg:h-[100vh]  max-lg:bg-yellow-300 max-lg:top-0 max-lg:left-[-100%] max-lg:flex-col  max-lg:items-center max-lg:justify-center duration-300 z-[2]`}>
            ...
            <div className='max-w-[1140px] mx-auto px-[12px] w-full flex flex-grow items-center'>                
                    <div className='w-full  z-[1] relative pt-[160px]' data-aos="zoom-in">
                        ...
                        <div className="pt-[63px] flex justify-end z-1  relative ">
                            <div className="flex pb-[44px]">
                                <h6 className=' font-helvetica  text-white font-normal text-[16px] leading-[27px]  ps-[13px] max-w-[170px] uppercase relative after:absolute after:top-[1px] after:left-0 after:w-[2px] after:h-full after:bg-Barneypurple after:inline-block '>Die wichtigsten Aspekte einer Trennung:</h6>
                                <div className="flex flex-col">
                                    <div className="flex">
                                        <div className="w-1 h-1 rounded-[50%] bg-white  m-[10px]"></div>
                                        <h6 className=' font-poppins font-medium fs-[16px] leading-[25px] text-white '>Physische Trennung</h6>
                                    </div>
                                    <div className="flex pt-[2px]">
                                        <div className="w-1 h-1 rounded-[50%] bg-white  m-[10px]"></div>
                                        <h6 className=' font-poppins font-medium fs-[16px] leading-[25px] text-white '>Mentale Trennung
                                        </h6>
                                    </div>
                                </div>
